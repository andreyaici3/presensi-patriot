<x-app-layout menuActive="operator">
    @section('breadcrumb')
    <div class="col-sm-6">
        <h1 class="m-0">EDIT DATA OPERATOR</h1>
    </div><!-- /.col -->
    <div class="col-sm-6">
        ...
        <div class="row">
            <div class="col-6">
                <div class="card card-info">
                    ...
                    <form class="form-horizontal" action="{{ route('operator.update', ["id" => $user->id]) }}" method="POST">
                        @csrf
                        @method('put')
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="name" placeholder="Masukan Nama Guru" name="name" value="{{ $user->name }}">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="role" id="role" class="form-control">
                                        ...
                                        <option value="ict" {{ ($user->role == "ict") ? "selected" : "" }}>Information Center</option>
                                        <option value="user" {{ ($user->role == "user") ? "selected" : "" }}>Kurikulum</option>
                                    </select>
                                </div>
                            </div>
