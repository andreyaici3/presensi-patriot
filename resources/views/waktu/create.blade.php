<x-app-layout menuActive="waktu" menuOpen="master">
    @section('breadcrumb')
    <div class="col-sm-6">
        <h1 class="m-0">TAMBAH DATA JAM</h1>
    </div><!-- /.col -->
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="/">Home</a></li>
            <li class="breadcrumb-item"><a href="/waktu">Data JAM</a></li>
            <li class="breadcrumb-item active">Tambah Data JAM</li>
        </ol>
    </div><!-- /.col -->
    @endsection
        ...
        <div class="row">
            <div class="col-6">
                <div class="card card-info">
                    ...
                    <form class="form-horizontal" action="/waktu" method="POST">
                        @csrf
                        <div class="card-body">
                            <div class="form-group row">
                                <label for="Mulai" class="col-sm-2 col-form-label">Mulai</label>
                                <div class="col-sm-2">
                                    <input type="time" id="24h" class="form-control" name="mulai" />
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="selesai" class="col-sm-2 col-form-label">Selesai</label>
                                <div class="col-sm-2">
                                    <input type="time" name="selesai" id="24h" class="form-control"/>
                                </div>
                            </div>
                        </div>
