<x-app-layout-v2 menuOpen="Report Data Staff" title="Laporan Bulanan Staff" menuActive="Laporan Bulanan Staff" >
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="date" type="text" value="{{ request()->tanggal ?? now()->format('d M Y') }}" />
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-12">
                            <div class="form-group">
                                ...
                                <a href="{{ route('manage.report.bulananStaff') }}" name="reset" class="btn btn-danger">Reset</a>
                            </div>
                        </div>
