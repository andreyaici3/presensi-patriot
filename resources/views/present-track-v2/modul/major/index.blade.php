<x-app-layout-v2 menuActive="Data Major" menuOpen="Master Data" title="Data Jurusan">
    <div class="min-height-200px">
        <div class="page-header">
         ...
         <div class="card-box mb-30 pd-20">
             <div class="pd-20">
                 <h4 class="text-blue h4">Daftar Jurusan</h4>
                 <a href="{{ route('manage.major.create') }}" class="btn btn-primary">Tambah</a>
             </div>
             <div class="pb-20">
                             ...
                             <tr>
                                 ...
                                 <td>
                                     <form id="formDelete-{{ $value->id }}"
                                         action="{{ route('manage.major.delete', ['id' => $value->id]) }}"
                                         method="post" style="display: none;">
                                         @csrf
                                         @method('DELETE')
                                     </form>
                                     <div class="table-actions">
                                         <a href="{{ route('manage.major.edit', ['id' => $value->id]) }}" data-color="#265ed7" style="color: rgb(38, 94, 215);"><i class="icon-copy dw dw-edit2"></i></a>
