<x-app-layout-v2 menuActive="Data Mapel" title="Data Mapel">
    <div class="min-height-200px">
        <div class="page-header">
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    <div class="title">
                        <h4>Kelola Data Mata Pelajaran</h4>
                    </div>
         ...
         <div class="card-box mb-30 pd-20">
             <div class="pd-20">
                 <h4 class="text-blue h4">Daftar Mata Pelajaran</h4>
                 <a href="{{ route('manage.subject.create') }}" class="btn btn-primary">Tambah</a>
                 <a href="{{ route('manage.subject.create') }}" class="btn btn-success ml-2">Mapping Mapel</a>
             </div>
             <div class="pb-20">
